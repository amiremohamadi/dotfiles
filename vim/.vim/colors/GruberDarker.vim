...
call <sid>hi('TabLineSel',      '',              s:gruberBG1, '', '')
call <sid>hi('TabLine',         s:gruberFG3,     s:gruberBG, '', '')
...
call <sid>hi('MatchParen',    s:gruberFG,         s:gruberBG2, '',        '')
...
call <sid>hi('SignColumn',    s:gruberFG,         s:gruberBG,    '',        '')
call <sid>hi('VertSplit',     s:gruberFG2,        s:gruberBG1,   '',        '')
call <sid>hi('ColorColumn',   '',                 s:gruberBG3,   '',        '')
...
call <sid>hi('PMenuSel',      s:gruberBG,         s:gruberBG2,   '',        '')
